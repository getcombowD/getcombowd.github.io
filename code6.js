...
gdjs.PlaygroundCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7142772);
}
}}
...
}; //End of gdjs.PlaygroundCode.eventsList0xb0aa8
...
gdjs.PlaygroundCode.eventsList0xb0aa8(runtimeScene);
return;
}
